...
public enum Messages
{
    ...
    ResizeFailTooClose("You can't resize into that claim's buffer.  Only a bigger and older claim can grow into a neighbor's buffer."),
    ...
    CreateClaimFailTooClose("Claims must be at least {0} blocks apart.  Your selected area is too close to another claim.", "0: minimum distance between claims"),
    ...
    NoPermissionNearClaim("You can't do that within {0} blocks of {1}'s claim.  Ask them for trust.", "0: buffer radius, 1: owner name"),
